...
def create_app(data_dir: Path, anonymize: bool = False) -> FastAPI:
    ...
    def api_positions(anonymize: bool = False, by_retirement: bool = False):
        df = _load(anonymize)
    ...
    def api_concentration(anonymize: bool = False, by_retirement: bool = False):
        df = _load(anonymize)
    ...
    def api_decomposition(no_account_type: bool = False, anonymize: bool = False, by_retirement: bool = False):
        df = _load(anonymize)
    ...
    def api_allocations(anonymize: bool = False, by_retirement: bool = False):
        df = _load(anonymize)
    ...
    def api_precious_metals(anonymize: bool = False, by_retirement: bool = False):
        df = _load(anonymize)
